...
const Section6b = () => {
  ...
  useEffect(() => {
    ...
    setPosisiAtasElementMetropolitanKedua(posisiMetropolitanKedua.left);
  }, [posisiAtasElementMetropolitanKedua]);
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Kota Palembang, Kabupaten Banyuasin, Kabupaten Ogan Ilir, dan
        ...
        >
          <img
            src="assets/image/city-icon/patungraya-agung.png"
            alt="Icon Patungraya Agung"
            style={{ width: "100%" }}
          />
        </Box>
      </Box>
