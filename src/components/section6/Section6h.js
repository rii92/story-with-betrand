...
const Section6h = () => {
  ...
  useEffect(() => {
    ...
    setPosisiAtasElementMetropolitanKedelapan(posisiMetropolitanKedelapan.left);
  }, [posisiAtasElementMetropolitanKedelapan]);
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Kota Denpasar, Kabupaten Badung, Kabupaten Kabupaten Gianyar, dan
          Kabupaten Tabanan
        </Typography>
        <Typography
          variant="h4"
        ...
        >
          <img
            src="assets/image/city-icon/sarbagita.png"
            alt="Icon Sarbagita"
            style={{ width: "100%" }}
          />
        </Box>
